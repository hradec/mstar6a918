 ...
 */
#if defined CONFIG_MP_PLATFORM_CPU_SETTING && (defined CONFIG_MSTAR_CPU_setting || defined CONFIG_MSTAR_CPU_calibrating)
...
#endif // CONFIG_MP_PLATFORM_CPU_SETTING && CONFIG_MSTAR_CPU_setting
