...
#include <linux/efi.h>      // tick.h
#include <linux/tick.h>     // reg_readw
...
#ifdef ZRAM_STAT
extern u32 cnt_enc, cnt_dec, time_enc, time_dec;

__always_inline u32 gettime(void) {
    u32 PiuTick;
