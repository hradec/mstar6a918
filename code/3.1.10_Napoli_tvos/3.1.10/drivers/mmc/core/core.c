...
#include "../../mstar/mmc/host/eMMCDrv/inc/common/eMMC.h"
#endif
					...
					unsigned long mode, void *unused)
{
	...
	MMC_printk("%s: mode %lud, bus_resume_flags %d rescan_disable %d", mmc_hostname(host), mode, host->bus_resume_flags, host->rescan_disable);
	...
	case PM_SUSPEND_PREPARE:
		...
		mmc_release_host(host);
		host->pm_flags = 0;
		MMC_printk("mode %lud ended", mode);
		break;
