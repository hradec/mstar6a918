...
int __init hidraw_init(void)
{
	...
	printk("This is hidraw init for linux source with original trylock  patch!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n");
	if (result < 0) {
