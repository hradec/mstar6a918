...
#if (_USB_128_ALIGMENT) && (MP_USB_MSTAR==1)
...
struct ehci_iso_stream {
	...
	u32			pre_now;     /* previous frame index */
#endif
...
/* Returns the speed of a device attached to a port on the root hub. */
static inline unsigned int
ehci_mstar_port_speed(struct ehci_hcd *ehci, unsigned int bmcs)
{
	if (bmcs & 0x80)
		return 0; // forced full speed
