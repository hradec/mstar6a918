 ...
 */
#if MP_CA7_Performance_Monitor_Enable
...
static const unsigned armv7_a7_perf_cache_map[PERF_COUNT_HW_CACHE_MAX]
        ...
        [C(LL)] = {
                [C(OP_READ)] = {
                        [C(RESULT_ACCESS)]      = ARMV7_PERFCTR_L2_DCACHE_ACCESS,
                        [C(RESULT_MISS)]        = ARMV7_PERFCTR_L2_DCACHE_REFILL,
                },
                [C(OP_WRITE)] = {
                        [C(RESULT_ACCESS)]      = ARMV7_PERFCTR_L2_DCACHE_ACCESS,
                        [C(RESULT_MISS)]        = ARMV7_PERFCTR_L2_DCACHE_REFILL,
...
#ifdef MP_PLATFORM_ARM_PMU
/* extern function for local_timer call it */
irqreturn_t armpmu_handle_irq(int irq_num, void *dev)
{
	return armv7pmu_handle_irq(irq_num, dev);
}
#endif
...
#if MP_CA7_Performance_Monitor_Enable
static const struct arm_pmu *__init armv7_a7_pmu_init(void)
{
        armv7pmu.id             = ARM_PERF_PMU_ID_CA7;
        armv7pmu.name           = "ARMv7 Cortex-A7";
	armv7pmu.cache_map	= &armv7_a7_perf_cache_map;
	armv7pmu.event_map	= &armv7_a7_perf_map;
        armv7pmu.num_events     = armv7_read_num_pmnc_events();
        return &armv7pmu;
}
#endif
