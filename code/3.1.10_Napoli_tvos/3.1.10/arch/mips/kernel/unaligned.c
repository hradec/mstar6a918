...
#endif // End of CONFIG_MP_MIPS_MIPS16E_UNALIGNED_ACCESS
	...
	void __user *addr, unsigned int __user *pc)
{
	...
	case sh_op:
		...
		if (res)
			goto fault;
#ifndef CONFIG_MP_MIPS_MIPS16E_UNALIGNED_ACCESS
		compute_return_epc(regs);
#endif // End of CONFIG_MP_MIPS_MIPS16E_UNALIGNED_ACCESS
		break;
...
fault:
 ...
 static void emulate_load_store_MIPS16e(struct pt_regs *regs, void __user * 
addr)
 {
        unsigned long value;
        unsigned int res;
