...
struct platform_device kaiser_device_satahost =
{
	.name		= "Mstar-sata",
	.id		= 0,
	.dev		= {
...
static struct platform_device Mstar_mspi_device = {
	.name		= "mspi_spi",
	.id		= 0,
};
#endif
...
static struct platform_device Mstar_isp_device = {
	.name		= "isp_spi",
	.id		= 1,
};
#endif
