...
#define FIQ_CMDQ                (0x01 << (E_FIQ_CMDQ             - E_FIQH_START))
...
#define FIQ_FRCR2ARM            (0x01 << (E_FIQ_FRCR2ARM         - E_FIQH_START))
...
#define IRQ_AU_DMA              (0x01 << (E_IRQ_AU_DMA           - E_IRQL_START))
...
#define IRQ_ERROR_RESP          (0x01 << (E_IRQ_ERROR_RESP       - E_IRQL_START))
#define IRQ_COMB                (0x01 << (E_IRQ_COMB             - E_IRQL_START))
#define IRQ_LDM_DMA_DONE0       (0x01 << (E_IRQ_LDM_DMA_DONE0    - E_IRQL_START))
...
#define IRQ_LDM_DONE_INT1       (0x01 << (E_IRQ_LDM_DONE_INT1    - E_IRQH_START))
#define IRQ_SMART               (0x01 << (E_IRQ_SMART            - E_IRQH_START))
#define IRQ_CBUS_PM             (0x01 << (E_IRQ_CBUS_PM          - E_IRQH_START))
#define IRQ_U3_DPHY             (0x01 << (E_IRQ_U3_DPHY          - E_IRQH_START))
...
#define IRQEXPL_MIIC_DMA2       (0x01 << (E_IRQEXPL_MIIC_DMA2    - E_IRQEXPL_START))
#define IRQEXPL_MASTER_IIC2     (0x01 << (E_IRQEXPL_MASTER_IIC2  - E_IRQEXPL_START))
...
#define IRQEXPH_MASTER_IIC1     (0x01 << (E_IRQEXPH_MASTER_IIC1  - E_IRQEXPH_START))
#define IRQEXPH_MIIC_DMA0       (0x01 << (E_IRQEXPH_MIIC_DMA0    - E_IRQEXPH_START))
#define IRQEXPH_MASTER_IIC0     (0x01 << (E_IRQEXPH_MASTER_IIC0  - E_IRQEXPH_START))
...
#define FIQEXPL_GPIO0           (0x01 << (E_FIQEXPL_GPIO0           - E_FIQEXPL_START))
#define FIQEXPL_ARM_TO_SECURER2 (0x01 << (E_FIQEXPL_ARM_TO_SECURER2 - E_FIQEXPL_START))
...
#define FIQEXPL_GPIO1           (0x01 << (E_FIQEXPL_GPIO1           - E_FIQEXPL_START))
#define FIQEXPL_ARMC1_TO_SECURER2   (0x01 << (E_FIQEXPL_ARMC1_TO_SECURER2 - E_FIQEXPL_START))
#define FIQEXPL_ARMC1_TO_ARM    (0x01 << (E_FIQEXPL_ARMC1_TO_ARM    - E_FIQEXPL_START))
#define FIQEXPL_ARMC1_TO_8051   (0x01 << (E_FIQEXPL_ARMC1_TO_8051   - E_FIQEXPL_START))
#define FIQEXPL_GPIO2           (0x01 << (E_FIQEXPL_GPIO2           - E_FIQEXPL_START))

// #define REG_FIQEXP_PENDING_H
#define FIQEXPH_SECURER2_TO_ARMC1   (0x01 << (E_FIQEXPH_SECURER2_TO_ARMC1- E_FIQEXPH_START))
#define FIQEXPH_SECURER2_TO_ARM     (0x01 << (E_FIQEXPH_SECURER2_TO_ARM  - E_FIQEXPH_START))
...
#define FIQEXPH_GPIO3           (0x01 << (E_FIQEXPH_GPIO3            - E_FIQEXPH_START))
#define FIQEXPH_GPIO4           (0x01 << (E_FIQEXPH_GPIO4            - E_FIQEXPH_START))
#define FIQEXPH_GPIO5           (0x01 << (E_FIQEXPH_GPIO5            - E_FIQEXPH_START))
#define FIQEXPH_GPIO6           (0x01 << (E_FIQEXPH_GPIO6            - E_FIQEXPH_START))
...
#define FIQEXPH_GPIO7           (0x01 << (E_FIQEXPH_GPIO7            - E_FIQEXPH_START))
