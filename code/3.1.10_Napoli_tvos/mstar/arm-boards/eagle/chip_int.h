...
//FIQ registers
#define REG_FIQ_MASK_L              (REG_INT_BASE + (0x044<< 2))
#define REG_FIQ_MASK_H              (REG_INT_BASE + (0x045<< 2))
#define REG_FIQ_CLEAR_L             (REG_INT_BASE + (0x04c<< 2))
#define REG_FIQ_CLEAR_H             (REG_INT_BASE + (0x04d<< 2))
#define REG_FIQ_PENDING_L           (REG_INT_BASE + (0x04c<< 2))
#define REG_FIQ_PENDING_H           (REG_INT_BASE + (0x04d<< 2))

//FIQ EXP registers
#define REG_FIQ_EXP_MASK_L          (REG_INT_BASE + (0x046<< 2))
#define REG_FIQ_EXP_MASK_H          (REG_INT_BASE + (0x047<< 2))
#define REG_FIQ_EXP_CLEAR_L         (REG_INT_BASE + (0x04e<< 2))
#define REG_FIQ_EXP_CLEAR_H         (REG_INT_BASE + (0x04f<< 2))
#define REG_FIQ_EXP_PENDING_L       (REG_INT_BASE + (0x04e<< 2))
#define REG_FIQ_EXP_PENDING_H       (REG_INT_BASE + (0x04f<< 2))
