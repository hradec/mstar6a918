...
#include <linux/delay.h>
#define CRC_PATTERN_REG1        0xA0
#define CRC_PATTERN_REG2        0xA2
#define CRC_LX1_REG_ST          0xA4
#define CRC_LX1_REG_SZ          0xA6
#define CRC_LX2_REG_ST          0xA8
#define CRC_LX2_REG_SZ          0xAA
#define CRC_LX3_REG_ST          0xAC
#define CRC_LX3_REG_SZ          0xAE
...
{
    volatile unsigned long *int_mask_base=(volatile unsigned long *)INT_MASK_REG_BASE;
    int_mask_base[0x4c]=0xFFFF;int_mask_base[0x4c]=0;
    int_mask_base[0x4d]=0xFFFF;int_mask_base[0x4d]=0;
    int_mask_base[0x4e]=0xFFFF;int_mask_base[0x4e]=0;
    int_mask_base[0x4f]=0xFFFF;int_mask_base[0x4f]=0;
    int_mask_base[0x5c]=0xFFFF;int_mask_base[0x5c]=0;
    int_mask_base[0x5d]=0xFFFF;int_mask_base[0x5d]=0;
    int_mask_base[0x5e]=0xFFFF;int_mask_base[0x5e]=0;
    int_mask_base[0x5f]=0xFFFF;int_mask_base[0x5f]=0;
}
