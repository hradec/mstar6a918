...
typedef enum
{
    ...
    E_IRQ_VIVALDI_DMA_INTR2                     = E_IRQL_START + 1, 
    E_IRQ_VIVALDI_DMA_INTR1                     = E_IRQL_START + 2, 
...
//  E_IRQ_RESERVED                               = E_IRQL_START + 15,
...
//  E_FIQ_RESERVED                              = E_FIQL_START + 6,
//  E_FIQ_RESERVED                              = E_FIQL_START + 7,
...
//  E_FIQ_RESERVED                              = E_FIQH_START + 6,
    E_FIQ_VDMCU2HK                              = E_FIQH_START + 7,
//  E_FIQ_RESERVED                              = E_FIQH_START + 8,
...
//  E_IRQEXPL_RESERVED                          = E_IRQEXPL_START + 8,
    ...
    E_IRQEXPL_SWCD_INT                          = E_IRQEXPL_START + 11,  
...
//  E_IRQEXPL_RESERVED                          = E_IRQEXPH_START + 3,
...
//  E_IRQEXPL_RESERVED                          = E_IRQEXPH_START + 5,
    ...
    //E_FIQEXPL_RESERVED                    = E_FIQEXPL_START + 1,
    //E_FIQEXPL_RESERVED                             = E_FIQEXPL_START + 2,   
...
//  E_FIQEXPH_RESERVED                          = E_FIQEXPH_START + 9, 
    E_FIQEXPH_DMA_DONE_INT                      = E_FIQEXPH_START + 10, 
...
#define FIQEXPL_IR_IN                           (0x01 << (E_FIQ_IR - E_FIQH_START))
...
#define IRQ_VIVALDI_DMA_INTR2                   (0x01 << (E_IRQ_VIVALDI_DMA_INTR2 - E_IRQL_START))
#define IRQ_VIVALDI_DMA_INTR1                   (0x01 << (E_IRQ_VIVALDI_DMA_INTR1 - E_IRQL_START))
...
#define FIQEXPH_DMA_DONE_INT                    (0x01 << (E_FIQEXPH_DMA_DONE_INT - E_FIQEXPH_START))
