...
#if defined(CONFIG_MSTAR_TITANIA13_BD_FPGA) || defined(CONFIG_MSTAR_AMBER6_BD_FPGA)
    #define MS_BOARD_TYPE_SEL       BD_FPGA
#elif defined(CONFIG_MSTAR_TITANIA13_BD_GENERIC) || defined(CONFIG_MSTAR_AMBER6_BD_GENERIC)
