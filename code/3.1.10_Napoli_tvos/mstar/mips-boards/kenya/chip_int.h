...
typedef enum
{
    ...
    E_IRQ_EMAC                  = E_IRQL_START  + 14,
    E_IRQ_SECEMAC               = E_IRQL_START  + 15,
    ...
    E_FIQEXPL_ERROR_RESP                = E_FIQEXPL_START+7,
    ...
    #define IRQEXPL_FCIE                        (0x1 << (E_IRQEXPL_FCIE               - E_IRQEXPL_START) )
    ...
    #define FIQEXPL_ERROR_RESP                  (0x1 << (E_FIQEXPL_ERROR_RESP                - E_FIQEXPL_START) )
    ...
    //#define FIQEXPH_REG_HST3to2                 (0x1 << (E_FIQEXPH_REG_HST3to2               - E_FIQEXPH_START) )
    //#define FIQEXPH_REG_HST3to1                 (0x1 << (E_FIQEXPH_REG_HST3to1               - E_FIQEXPH_START) )
    //#define FIQEXPH_REG_HST3to0                 (0x1 << (E_FIQEXPH_REG_HST3to0               - E_FIQEXPH_START) )
