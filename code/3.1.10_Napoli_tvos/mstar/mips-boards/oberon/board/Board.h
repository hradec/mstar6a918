...
#if defined(CONFIG_MSTAR_OBERON_BD_MST060A_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST060A_D01A_S
#else
...
/////////////////////////////////////////////////////////
#if   (MS_BOARD_TYPE_SEL == BD_MST060A_D01A_S)
    #include "BD_MST060A_D01A_S.h"
#else
