...
//  E_IRQ_RESERVED                              = E_IRQH_START + 7, 
    E_IRQ_RIU_ERROR                             = E_IRQH_START + 8, 
...
//  E_FIQ_RESERVED                              = E_FIQH_START + 14,
    ...
    E_IRQEXPL_MIU_SECURE                        = E_IRQEXPL_START + 10,  
    ...
    E_IRQEXPH_UART3                             = E_IRQEXPH_START + 10,    
    ...
    E_FIQEXPL_TIMER2                            = E_FIQEXPL_START + 3,  
...
//  E_FIQEXPL_RESERVED                          = E_FIQEXPL_START + 11,     
    ...
    E_FIQEXPH_MIPS_SECURER2_TO_AEON             = E_FIQEXPL_START + 13,
    E_FIQEXPH_MIPS_SECURER2_TO_8051             = E_FIQEXPL_START + 14,
//  E_FIQEXPL_RESERVED                          = E_FIQEXPL_START + 15,     
    ...
    E_FIQEXPH_AU_SPDIF0                         = E_FIQEXPH_START + 7, 
    E_FIQEXPH_AU_SPDIF1                         = E_FIQEXPH_START + 8, 
...
#define IRQ_IIC3                                (0x01 << (E_IRQ_IIC3 - E_IRQL_START))
#define IRQ_IIC2                                (0x01 << (E_IRQ_IIC2 - E_IRQL_START))
#define IRQ_IIC1                                (0x01 << (E_IRQ_IIC1 - E_IRQL_START))
...
#define IRQ_RIU_ERROR                           (0x01 << (E_IRQ_RIU_ERROR - E_IRQH_START))
...
#define IRQ_MVD2MIPS                            (0x01 << (E_IRQ_MVD2MIPS - E_IRQH_START))
#define IRQ_SWCD                                (0x01 << (E_IRQ_SWCD - E_IRQH_START))
...
#define IRQEXPL_MIU_SECURE                      (0x01 << (E_IRQEXPL_MIU_SECURE - E_IRQEXPL_START))
...
#define IRQEXPH_MHL_CBUS_PM                     (0x01 << (E_IRQEXPH_MHL_CBUS_PM - E_IRQEXPH_START))
...
#define FIQEXPL_MIPS_VPE0_TO_SECURER2           (0x01 << (E_FIQEXPL_MIPS_VPE0_TO_SECURER2 - E_FIQEXPL_START))
#define FIQEXPL_MIPS_VPE0_TO_AEON               (0x01 << (E_FIQEXPL_MIPS_VPE0_TO_AEON - E_FIQEXPL_START))
#define FIQEXPL_MIPS_VPE0_TO_8051               (0x01 << (E_FIQEXPL_MIPS_VPE0_TO_8051 - E_FIQEXPL_START))
                                                
#define FIQEXPH_MASK                            0xFFFF
#define FIQEXPH_SECURER2_TO_MIPS_VPE0          (0x01 << (E_FIQEXPH_SECURER2_TO_MIPS_VPE0 - E_FIQEXPH_START))
#define FIQEXPH_SECURER2_TO_AEON               (0x01 << (E_FIQEXPH_SECURER2_TO_AEON - E_FIQEXPH_START))
#define FIQEXPH_SECURER2_TO_8051               (0x01 << (E_FIQEXPH_SECURER2_TO_8051 - E_FIQEXPH_START))
#define FIQEXPH_USB1                           (0x01 << (E_FIQEXPH_USB1      - E_FIQEXPH_START))
#define FIQEXPH_UHC1                           (0x01 << (E_FIQEXPH_UHC1      - E_FIQEXPH_START))
#define FIQEXPH_LDM_DMA1                       (0x01 << (E_FIQEXPH_LDM_DMA1  - E_FIQEXPH_START))
#define FIQEXPH_LDM_DMA0                       (0x01 << (E_FIQEXPH_LDM_DMA0  - E_FIQEXPH_START))
#define FIQEXPH_AU_SPDIF0                      (0x01 << (E_FIQEXPH_AU_SPDIF0 - E_FIQEXPH_START))
#define FIQEXPH_AU_SPDIF1                      (0x01 << (E_FIQEXPH_AU_SPDIF1 - E_FIQEXPH_START))
