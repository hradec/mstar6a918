...
#define IR_HEADER_CODE3         0xAA          // Custom 3
#define IR_HEADER_CODE4         0x55          // Custom 4
// for pioneer double code
#define IR_HEADER_CODE5         0xAF          // Custom 5
#define IR_HEADER_CODE6         0x50          // Custom 6
#else
