...
//####################
//
// For communication with FRC
//
//////////////////////////////////////////////////////////////
//busy bit Set/Clear/Get
#define   _F_BUSY_S(arg) {\
                            MS_U8 val; \
                            mb();\
                            val = REG8_MBX_GROUP(arg, REG8_MBX_FRC_STATE_1);\
                            mb();\
                            REG8_MBX_GROUP(arg, REG8_MBX_FRC_STATE_1) = val | MBX_STATE1_BUSY;\
                            mb();\
                         }

#define   _F_BUSY_C(arg) {\
                            MS_U8 val; \
                            mb();\
                            val = REG8_MBX_GROUP(arg, REG8_MBX_FRC_STATE_1);\
                            mb();\
...
#define   _F_BUSY(arg)   (REG8_MBX_GROUP(arg, REG8_MBX_FRC_STATE_1) & MBX_STATE1_BUSY);
...
#define   _F_ERR_S(arg)  {\
                            ...
                            val = REG8_MBX_GROUP(arg, REG8_MBX_FRC_STATE_1);\
                            mb();\
                            REG8_MBX_GROUP(arg, REG8_MBX_FRC_STATE_1) = val | MBX_STATE1_ERROR;\
                            mb();\
                         }
...
#define   _F_ERR(arg)   (REG8_MBX_GROUP(arg, REG8_MBX_FRC_STATE_1) & MBX_STATE1_ERROR)

//////////////////////////////////////////////////////////////
//disabled bit Set/Clear/Get
#define   _F_DISABLED_S(arg)   {\
                            MS_U8 val;\
                            mb();\
                            val = REG8_MBX_GROUP(arg, REG8_MBX_FRC_STATE_1);\
                            mb();\
                            REG8_MBX_GROUP(arg, REG8_MBX_FRC_STATE_1) = val | MBX_STATE1_DISABLED;\
                            mb();\
                         }

#define   _F_DISABLED_C(arg)   {\
                            MS_U8 val;\
                            mb();\
                            val = REG8_MBX_GROUP(arg, REG8_MBX_FRC_STATE_1);\
                            mb();\
...
#define   _F_DISABLED(arg)    (REG8_MBX_GROUP(arg, REG8_MBX_FRC_STATE_1) & MBX_STATE1_DISABLED)

////////////////////////////////////////////////////////////////////////
//overflow bit Set/Clear/Get
#define   _F_OVERFLOW_S(arg)  {\
                                MS_U8 val;\
                                mb();\
                                val = REG8_MBX_GROUP(arg, REG8_MBX_FRC_STATE_1);\
                                mb();\
                                REG8_MBX_GROUP(arg, REG8_MBX_FRC_STATE_1) = val | MBX_STATE1_OVERFLOW;\
                                mb();\
                              }

#define   _F_OVERFLOW_C(arg)  {\
                                MS_U8 val;\
                                mb();\
                                val = REG8_MBX_GROUP(arg, REG8_MBX_FRC_STATE_1);\
                                mb();\
...
#define   _F_OVERFLOW(arg)   (REG8_MBX_GROUP(arg, REG8_MBX_FRC_STATE_1) & MBX_STATE1_OVERFLOW)
...
#define   _F_S1_C(arg)   {\
                            ...
                            val = REG8_MBX_GROUP(arg, REG8_MBX_FRC_STATE_1);\
                            mb();\
                            REG8_MBX_GROUP(arg, REG8_MBX_FRC_STATE_1) = val & ~(MBX_STATE1_DISABLED | MBX_STATE1_OVERFLOW | MBX_STATE1_ERROR | MBX_STATE1_BUSY);\
                            mb();\
                        }
