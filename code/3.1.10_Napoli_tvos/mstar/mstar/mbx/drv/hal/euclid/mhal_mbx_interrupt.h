...
// Defines & Macros
//=============================================================================
#define MBX_INT_AEON2PM     (E_FIQ_INT_AEON_TO_8051-E_FIQL_START)
#define MBX_INT_PM2AEON     (E_FIQ_INT_8051_TO_AEON-E_FIQL_START)
#define MBX_INT_PM2MIPS      (E_FIQ_INT_8051_TO_MIPS-E_FIQL_START)
#define MBX_INT_MIPS2PM      (E_FIQ_INT_MIPS_TO_8051-E_FIQL_START)
#define MBX_INT_MIPS2AEON  (E_FIQ_INT_MIPS_TO_AEON-E_FIQL_START)
#define MBX_INT_AEON2MIPS  (E_FIQ_INT_AEON_TO_MIPS-E_FIQL_START)
