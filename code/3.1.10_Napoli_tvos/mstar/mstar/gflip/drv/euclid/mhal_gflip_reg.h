...
#define REG_GOP_CTRL0        0X0001
    #define GOP_DST_B2    BIT(5)
...
//----------------------------------------------------------------------------
#define CKG_REG_BASE                           0x1E00
#define CKG_REG(addr)                           RIU[(addr<<1)+CKG_REG_BASE]

/* GOP0 and GOP1 CLK */
#define GOP_GOPCLK             0x18
    //#define CKG_GOPG0_DISABLE_CLK   ~(BIT(0))
    #define CKG_GOPG0_MASK          BMASK(3:2)
    #define CKG_GOPG0_ODCLK         BITS(3:2, 0)
    #define CKG_GOPG0_IDCLK2        BITS(3:2, 1)
    #define CKG_GOPG0_MIXERCLK      BITS(3:2, 3)

    //#define CKG_GOPG1_DISABLE_CLK   ~(BIT(8))
    #define CKG_GOPG1_MASK          BMASK(7:6)
    #define CKG_GOPG1_ODCLK         BITS(7:6, 0)
    #define CKG_GOPG1_IDCLK2        BITS(7:6, 2)
    #define CKG_GOPG1_MIXERCLK      BITS(7:6, 3)

    #define CKG_GOPG2_MASK          BMASK(11:10)
    #define CKG_GOPG2_ODCLK         BITS(11:10, 0)
    #define CKG_GOPG2_IDCLK2        BITS(11:10, 1)
    #define CKG_GOPG2_MIXERCLK      BITS(11:10, 3)

    #define CKG_GOPGD_MASK          BMASK(15:14)
    #define CKG_GOPD_CLK_ODCLK      BITS(15:14, 0)
