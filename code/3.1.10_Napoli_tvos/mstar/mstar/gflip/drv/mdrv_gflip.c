...
int MDrv_GFLIP_Resume(void)
{
    ...
    for(i = 0; i < MAX_GOP_SUPPORT; i++){//restore gwin enable
        ...
        MHal_GFLIP_WriteGopReg(0,GFLIP_GOP_BANK_IDX_0,REG_GOP_BANK_SEL,GOP_FWR,GOP_FWR);
        MHal_GFLIP_WriteGopReg(0,GFLIP_GOP_BANK_IDX_0,REG_GOP_BANK_SEL,0,GOP_FWR);
    }
    return 0;
}
