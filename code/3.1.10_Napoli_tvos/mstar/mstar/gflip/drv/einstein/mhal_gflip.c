...
MS_BOOL MHal_GFLIP_SetFlipToGop(MS_U32 u32GopIdx, MS_U32 u32GwinIdx, MS_U32 u32MainAddr, MS_U32 u32SubAddr, MS_BOOL bForceWriteIn)
{
    ...
    else
    {
        ...
        {
            GOP_REG(REG_GOP_BANK_SEL, MHal_GFLIP_GetBankOffset(u32GopIdx, GFLIP_GOP_BANK_IDX_0)) = (u16GOPWAck & (~GOP_BANK_SEL)) | u8BankOffset | GOP_BK_WR;
            GOP_REG(REG_GOP_BANK_SEL, MHal_GFLIP_GetBankOffset(u32GopIdx, GFLIP_GOP_BANK_IDX_0)) &= ~GOP_BK_WR;
            GOP_REG(REG_GOP_BANK_SEL, MHal_GFLIP_GetBankOffset(u32GopIdx, GFLIP_GOP_BANK_IDX_0)) = (GOP_REG(REG_GOP_BANK_SEL, MHal_GFLIP_GetBankOffset(u32GopIdx, GFLIP_GOP_BANK_IDX_0)) & (~GOP_BANK_SEL)) | (u16GOPWAck & GOP_BANK_SEL);//Restore bank
        }
    }
    return TRUE;
}
...
MS_BOOL MHal_GFLIP_SetMultiFlipToGop(MS_GFLIP_MULTIINFO* pMultiFlipInfo,MS_BOOL bForceWriteIn)
{
    ...
    {
        _MHal_GFLIP_WriteGopReg(pMultiFlipInfo->astGopInfo[i].u32GopIdx, GFLIP_GOP_BANK_IDX_1, REG_GOP_DRAM_RBLK_STR_L(pMultiFlipInfo->astGopInfo[i].u32GwinIdx), LO16BIT((pMultiFlipInfo->astGopInfo[i].u32MainAddr>> GFLIP_ADDR_ALIGN_RSHIFT)), 0xFFFF);
        _MHal_GFLIP_WriteGopReg(pMultiFlipInfo->astGopInfo[i].u32GopIdx, GFLIP_GOP_BANK_IDX_1, REG_GOP_DRAM_RBLK_STR_H(pMultiFlipInfo->astGopInfo[i].u32GwinIdx), HI16BIT((pMultiFlipInfo->astGopInfo[i].u32MainAddr>> GFLIP_ADDR_ALIGN_RSHIFT)), 0xFFFF);
        if((pMultiFlipInfo->astGopInfo[i].u32SubAddr>> GFLIP_ADDR_ALIGN_RSHIFT) != 0)
        {
            _MHal_GFLIP_WriteGopReg(pMultiFlipInfo->astGopInfo[i].u32GopIdx, GFLIP_GOP_BANK_IDX_1, REG_GOP_3DOSD_SUB_RBLK_L(pMultiFlipInfo->astGopInfo[i].u32GwinIdx), LO16BIT((pMultiFlipInfo->astGopInfo[i].u32SubAddr>> GFLIP_ADDR_ALIGN_RSHIFT)), 0xFFFF);
            _MHal_GFLIP_WriteGopReg(pMultiFlipInfo->astGopInfo[i].u32GopIdx, GFLIP_GOP_BANK_IDX_1, REG_GOP_3DOSD_SUB_RBLK_H(pMultiFlipInfo->astGopInfo[i].u32GwinIdx), HI16BIT((pMultiFlipInfo->astGopInfo[i].u32SubAddr>> GFLIP_ADDR_ALIGN_RSHIFT)), 0xFFFF);
        }
