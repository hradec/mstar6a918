...
#define MIU1_BASE_ADDR        0x80000000
#define MIU1_BASE_ADDR_LOW    (MIU1_BASE_ADDR & 0xffff)
#define MIU1_BASE_ADDR_HIGH   ((MIU1_BASE_ADDR >> 16) & 0xffff)
...
void mstar_platform_power_on(void)
{
    ...
    G3D_REG(REG_MIU1_BASE_LOW)  = MIU1_BASE_ADDR_LOW;
    G3D_REG(REG_MIU1_BASE_HIGH) = MIU1_BASE_ADDR_HIGH;
    udelay(100);
