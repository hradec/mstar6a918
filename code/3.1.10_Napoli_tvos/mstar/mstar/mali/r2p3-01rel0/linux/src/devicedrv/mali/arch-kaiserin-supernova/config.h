...
/* Configuration for the Kaiserin Supernova platform */

#ifdef MSTAR_RIU_ENABLED
#define MALI_CORE_BASE(offset)  (0xbf280000 + (offset << 1))
#else
#define MALI_CORE_BASE(offset)  (0x1f800000 + (offset))
#endif

#define MALI_IRQ                (95)
#define MIU1_BASE               (0x20000000)
...
static _mali_osk_resource_t arch_configuration [] =
{
	...
	},
	{
		...
		.base = MIU1_BASE + 0x00000000,
		.size = 0x20000000,
		.cpu_usage_adjust = MIU1_BASE,
