...
#ifdef MSTAR
#define MALI_IOC_MEM_GET_CPU_ADJUST         _IOR(MALI_IOC_MEMORY_BASE, _MALI_UK_GET_CPU_ADJUST, _mali_uk_get_cpu_adjust *)
#ifdef MSTAR_MALI_DUMP_MEMORY_USAGE
#define MALI_IOC_MEM_DUMP_MEMORY_USAGE      _IOWR(MALI_IOC_MEMORY_BASE, _MALI_UK_MEMORY_USAGE_DUMPED, _mali_uk_memory_usage_dumped_s *)
#endif
