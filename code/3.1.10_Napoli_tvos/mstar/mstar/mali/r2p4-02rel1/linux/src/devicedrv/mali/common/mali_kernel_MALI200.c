...
#else
	irq_readout = mali_core_renderunit_register_read_no_lock(core, MALI200_REG_ADDR_MGMT_INT_STATUS);
#endif
...
#else
		mali_core_renderunit_register_write_no_lock(core, MALI200_REG_ADDR_MGMT_INT_MASK, MALI200_REG_VAL_IRQ_MASK_NONE);
#endif
