...
#ifdef MSTAR
	allocator = mali_os_allocator_create(size, PHYS_TO_BUS_ADDRESS_ADJUST, "Shared Mali GPU memory");
#else
...
#ifdef MSTAR
	allocator = mali_block_allocator_create(start, PHYS_TO_BUS_ADDRESS_ADJUST, size, "Dedicated Mali GPU memory");
#else
