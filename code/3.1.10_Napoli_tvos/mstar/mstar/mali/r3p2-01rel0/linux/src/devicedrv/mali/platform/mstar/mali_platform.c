...
#define MALI_BASE_ADDRESS (GPU_BASE_ADDRESS>>1)
#else
#define MALI_BASE_ADDRESS GPU_BASE_ADDRESS
#endif
...
static struct resource mali_gpu_resources[] =
{
...
#if defined(MALI400)
	#if NUM_PP == 1
		MALI_GPU_RESOURCES(MALI_BASE_ADDRESS, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ)
	#elif NUM_PP == 2
		MALI_GPU_RESOURCES(MALI_BASE_ADDRESS, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ)
	#elif NUM_PP == 3
		MALI_GPU_RESOURCES(MALI_BASE_ADDRESS, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ)
	#elif NUM_PP == 4
		MALI_GPU_RESOURCES(MALI_BASE_ADDRESS, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ)
	#else
		#error invalid NUM_PP for MALI400
	#endif
#elif defined(MALI450)
	#if NUM_PP == 2
		MALI_GPU_RESOURCES(MALI_BASE_ADDRESS, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ)
	#elif NUM_PP == 4
		MALI_GPU_RESOURCES(MALI_BASE_ADDRESS, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ)
	#elif NUM_PP == 6
		MALI_GPU_RESOURCES(MALI_BASE_ADDRESS, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ)
	#elif NUM_PP == 8
		MALI_GPU_RESOURCES(MALI_BASE_ADDRESS, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ)
	#else
	...
	#else
		MALI_GPU_RESOURCES(MALI_BASE_ADDRESS, MALI_IRQ, MALI_IRQ, MALI_IRQ)
	#endif
