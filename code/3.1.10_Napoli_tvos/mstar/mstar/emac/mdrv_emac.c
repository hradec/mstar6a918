...
static int MDev_EMAC_rx (struct net_device *dev)
{
    ...
    do
    {
        ...
        if (skb != NULL)
        {
            ...
            if (((p_recv[4]==dev->dev_addr[0])&&(p_recv[5]==dev->dev_addr[1])&&(p_recv[6]==dev->dev_addr[2])&&(p_recv[7]==dev->dev_addr[3])&&(p_recv[8]==dev->dev_addr[4])&&(p_recv[9]==dev->dev_addr[5])) || ((p_recv[4]==0xFF)&&(p_recv[5]==0xFF)&&(p_recv[6]==0xFF)&&(p_recv[7]==0xFF)&&(p_recv[8]==0xFF)&&(p_recv[9]==0xFF)))
            {
