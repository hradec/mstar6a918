...
#include "./include/mach/clkdev.h"

#include <asm/hardware/icst.h>
#include "./include/mach/lm.h"
#include "./include/mach/impd1.h"
#include <asm/sizes.h>
...
extern clkdev_alloc(struct clk *clk, const char *con_id, const char *dev_fmt, ...);
extern void clkdev_add(struct clk_lookup *cl);
extern void clkdev_drop(struct clk_lookup *cl);
