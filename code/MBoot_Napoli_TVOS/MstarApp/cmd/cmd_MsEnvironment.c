...
U_BOOT_CMD(
    add_moduletest, CONFIG_SYS_MAXARGS, 1,    do_add_moduletest,
    "add_moduletest   - Perform moduletest\n",
    NULL
);

U_BOOT_CMD(
    add_autotest, CONFIG_SYS_MAXARGS, 1,    do_add_autotest,
    "add_autotest   - Perform autotest\n",
    NULL
);

U_BOOT_CMD(
    add_hsl, CONFIG_SYS_MAXARGS, 1, do_add_hsl,
