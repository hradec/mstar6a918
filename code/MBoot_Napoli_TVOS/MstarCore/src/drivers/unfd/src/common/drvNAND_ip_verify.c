...
static U32 NCTEST_RWMultiplePages_OneTime(U32 u32_StartRowIdx, U32 u32_PageCnt)
{
	NAND_DRIVER *pNandDrv = drvNAND_get_DrvContext_address();
	U32 u32_Err;
	U32 u32_ByteIdx, u32_DataByteCnt, u32_SpareByteCnt, u32_i;
...
NCTEST_ECC_BCH_PageMode(U32 u32_TestRow)
{
	NAND_DRIVER *pNandDrv = drvNAND_get_DrvContext_address();
...
static U32 NCTEST_LFSRTest(U32 u32_PBA)
{
    ...
    switch(u16_loop)
    {
		case 2: // r without LFSR, page:0~2
			...
			{
				LFSR1_NLines_NIOs_SectorUnit(au8_WTmp,sgau16_ScrambledP00, pNandDrv->u16_PageByteCnt + pNandDrv->u16_SpareByteCnt,(u32_row + 0)  & pNandDrv->u16_BlkPageCntMask, 16, 16);
				LFSR1_NLines_NIOs_SectorUnit(au8_WTmp,sgau16_ScrambledP01, pNandDrv->u16_PageByteCnt + pNandDrv->u16_SpareByteCnt,(u32_row + 1) & pNandDrv->u16_BlkPageCntMask, 16, 16);
				LFSR1_NLines_NIOs_SectorUnit(au8_WTmp,sgau16_ScrambledP02, pNandDrv->u16_PageByteCnt + pNandDrv->u16_SpareByteCnt,(u32_row + 2) & pNandDrv->u16_BlkPageCntMask, 16, 16);
			}
			else
			{
				LFSR1_NLines_NIOs_SectorUnit(au8_WTmp,sgau16_ScrambledP00, pNandDrv->u16_PageByteCnt + pNandDrv->u16_SpareByteCnt,(u32_row + 0) & pNandDrv->u16_BlkPageCntMask, 16, 8);
				LFSR1_NLines_NIOs_SectorUnit(au8_WTmp,sgau16_ScrambledP01, pNandDrv->u16_PageByteCnt + pNandDrv->u16_SpareByteCnt,(u32_row + 1) & pNandDrv->u16_BlkPageCntMask, 16, 8);
				LFSR1_NLines_NIOs_SectorUnit(au8_WTmp,sgau16_ScrambledP02, pNandDrv->u16_PageByteCnt + pNandDrv->u16_SpareByteCnt,(u32_row + 2) & pNandDrv->u16_BlkPageCntMask, 16, 8);
			}
		...
		case 3:
			...
			if(pNandDrv->u16_Reg58_DDRCtrl & BIT_DDR_MASM)
			{
				LFSR1_NLines_NIOs_SectorUnit(au8_WTmp,sgau16_ScrambledP7F, pNandDrv->u16_PageByteCnt + pNandDrv->u16_SpareByteCnt,u32_row & pNandDrv->u16_BlkPageCntMask, 16, 16);
				LFSR1_NLines_NIOs_SectorUnit(au8_WTmp,sgau16_ScrambledP80, pNandDrv->u16_PageByteCnt + pNandDrv->u16_SpareByteCnt,(u32_row + 1) & pNandDrv->u16_BlkPageCntMask, 16, 16);
				LFSR1_NLines_NIOs_SectorUnit(au8_WTmp,sgau16_ScrambledP81, pNandDrv->u16_PageByteCnt + pNandDrv->u16_SpareByteCnt,(u32_row + 2) & pNandDrv->u16_BlkPageCntMask, 16, 16);
			}
			else
			{
				LFSR1_NLines_NIOs_SectorUnit(au8_WTmp,sgau16_ScrambledP7F, pNandDrv->u16_PageByteCnt + pNandDrv->u16_SpareByteCnt,u32_row & pNandDrv->u16_BlkPageCntMask, 16, 8);
				LFSR1_NLines_NIOs_SectorUnit(au8_WTmp,sgau16_ScrambledP80, pNandDrv->u16_PageByteCnt + pNandDrv->u16_SpareByteCnt,(u32_row + 1) & pNandDrv->u16_BlkPageCntMask, 16, 8);
				LFSR1_NLines_NIOs_SectorUnit(au8_WTmp,sgau16_ScrambledP81, pNandDrv->u16_PageByteCnt + pNandDrv->u16_SpareByteCnt,(u32_row + 2) & pNandDrv->u16_BlkPageCntMask, 16, 8);
			}
...
U32 drvNAND_IPVerify_Main(void)
{
	...
	#if defined(MT29F64G08CBAAB) &&MT29F64G08CBAAB
	au8_nand_clk_max = EMMC_PLL_1XCLK_86M_IDX;
	...
	*(volatile U16*)0x2A00724C |= (U16)BIT13; // not gate Disp clk]
	...
	for(u32_TestLoop = 0; u32_TestLoop < EMMC_PLL_1XCLK_TABLE_CNT - 1; u32_TestLoop ++)
	{
...
//	au8_nand_clk_max = EMMC_PLL_1XCLK_100M_IDX;
	...
	memcpy( &pNandDrv->tDefaultDDR, &all_clock_timing[u32_TestLoop % 11], sizeof(DDR_TIMING_GROUP_t));
	nand_config_clock(pNandDrv->u8_tREA);
	#endif
