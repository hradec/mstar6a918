...
DLL_PUBLIC MS_U32 UtopiaInit(void);
DLL_PUBLIC MS_U32 UtopiaOpen(MS_U32 u32ModuleID, void** pInstant, MS_U32 u32ModuleVersion, const void* const pAttribte);
DLL_PUBLIC MS_U32 UtopiaIoctl(void* pInstant, MS_U32 u32Cmd, void* const pArgs);
DLL_PUBLIC MS_U32 UtopiaClose(void* pInstant);
