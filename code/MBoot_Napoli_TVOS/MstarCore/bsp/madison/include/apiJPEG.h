...
DLL_PUBLIC void MApi_JPEG_SetNJPDInstance(MS_U8 JPDNum);
...
#endif
DLL_LOCAL void MApi_JPEG_SetVerificationMode(NJPEG_VerificationMode VerificationMode);
DLL_LOCAL NJPEG_VerificationMode MApi_JPEG_GetVerificationMode(void);
DLL_LOCAL void MApi_NJPD_Debug(void);
