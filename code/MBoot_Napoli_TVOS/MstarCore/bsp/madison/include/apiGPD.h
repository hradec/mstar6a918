...
DLL_PUBLIC void *MApi_GPD_Init(U32 SrcBuf);
DLL_PUBLIC S32 MApi_GPD_InputSource(gpd_pic_info* param, U32 InputBuf, U32 Size);
DLL_PUBLIC S32 MApi_GPD_OutputDecode(U32 DecodeBuf, U32 ocolor, U32 Size);
DLL_PUBLIC S32 MApi_GPD_OutputDecodeROI(U32 DecodeBuf, U32 ocolor, U32 Size, gpd_roi_info *roi);
DLL_PUBLIC S32 MApi_GPD_OutputDecodeMGIF(U32 DecodeBuf, U32 ocolor, U32 Size);
DLL_PUBLIC S32 MApi_GPD_GetDuration(void);
DLL_PUBLIC void MApi_GPD_SetGIFMode(int mode);
...
DLL_PUBLIC void MApi_GPD_ScalingEnable(U32 mode);
DLL_PUBLIC void MApi_GPD_ScalingDisable(void);
DLL_PUBLIC U32 MApi_GPD_SetControl(gpd_user_cmd cmd_id, U32 param);
DLL_PUBLIC U32 MApi_GPD_GetControl(gpd_get_cmd cmd_id, U32* param);
DLL_PUBLIC U32 MApi_GPD_GetCRCResult(const MS_U8 *pu8Data, MS_U32 u32Size, MS_U32 u32Width, unsigned int ocolor);
