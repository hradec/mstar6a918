...
//-------------------------------------------------------------------------------------------------
/// @brief \b Function \b Name: MDrv_VE_SetDolbyVerifier
/// @brief \b Function \b Description : Set frame buffer info for Dolby Verifier
/// @param  u32Addr  physical address of the frame buffer
/// @param  u32Size   size of the frame buffer
///
/// @return TRUE: success
/// @return FALSE: fail
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_VE_SetDolbyVerifier(MS_PHYADDR u32Addr, MS_U32 u32Size);
