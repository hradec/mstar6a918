...
#define LOGO_JPG_DRAM_ADDR      0x05B2C000
    #if(ENABLE_EAGLE==1 || ENABLE_EDISON==1 || ENABLE_EIFFEL==1 || ENABLE_NIKE==1 || ENABLE_MADISON==1  || ENABLE_CLIPPERS==1 || ENABLE_MIAMI==1 || ENABLE_NADAL==1 || ENABLE_EINSTEIN==1 || ENABLE_KAISERIN==1 ||ENABLE_KAISER==1 || ENABLE_EINSTEIN3==1)
