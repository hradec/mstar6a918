...
#define ENABLE_SECOND_EHC
	...
	(ENABLE_KAISER) || (ENABLE_MADISON) || (ENABLE_CLIPPERS) || (ENABLE_NAPOLI) || (ENABLE_MIAMI)
#define ENABLE_THIRD_EHC
#endif

#if defined(CONFIG_KAISERIN) || (ENABLE_EIFFEL) || (ENABLE_EINSTEIN) || (ENABLE_EINSTEIN3) || (ENABLE_NAPOLI)
